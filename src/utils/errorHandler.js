 ...
 * 
 * This module provides structured error handling for the ЭтерисБот application.
 * 
 * PHILOSOPHY:
 ...
 * 
 * USAGE:
 * - Throw ЭтерисБотError for application-specific errors
...
export function createError(message, type = ErrorTypes.UNKNOWN, userMessage = null, context = {}) {
    ...
    return new ЭтерисБотError(message, type, userMessage, normalizedContext);
}
